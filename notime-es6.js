var ntstrts =
  ""; /* 时间源,如果它被设置了值的话，将会使用它作为源，每1s更新一次 */
...
function msconv(ts) {
  ...
  if (
    ut.bnabscomp(ts, "3600000") == "no" &&
    ut.bnabscomp(ts, "59999") == "yes"
  ) {
  ...
  if (
    ut.bnabscomp(ts, "86400000") == "no" &&
    ut.bnabscomp(ts, "3599999") == "yes"
  ) {
  ...
  if (
    ut.bnabscomp(ts, "2592000000") == "no" &&
    ut.bnabscomp(ts, "86399999") == "yes"
  ) {
  ...
  if (
    ut.bnabscomp(ts, "31104000000") == "no" &&
    ut.bnabscomp(ts, "2591999999") == "yes"
  ) {
